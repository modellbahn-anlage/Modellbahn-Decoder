...
const int Druckknopf = 4;
const int DoIt = 8;                 //war vorher 7!!! Achtung
const int Knopfdruecker_rot = 13;
const int Knopfdruecker_gruen = 12;
int Musiktitel = 2;
int Durchgang = 0;
...
void loop() {
  ...
  //Druckknopf-Farbe = grün
  digitalWrite(LED_BUILTIN, HIGH);
  digitalWrite(Knopfdruecker_rot, LOW);
  digitalWrite(Knopfdruecker_gruen, HIGH);
  ...
  //Druckknopf-Farbe = orange
  digitalWrite(LED_BUILTIN, LOW);
  digitalWrite(Knopfdruecker_rot, HIGH);
  digitalWrite(Knopfdruecker_gruen, HIGH);
